...
__declspec(dllimport) PhidgetReturnCode __stdcall Phidget_getDeviceChannelCount	(PhidgetHandle phid, Phidget_ChannelClass, uint32_t *count);
...
/* Generated by WriteClassHeaderVisitor: Thu Oct 26 2017 10:45:16 GMT-0600 (Mountain Daylight Time) */
